...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
      ["anatomy.png",new URL("./files/anatomy",import.meta.url)],
      ["profit@1.csv",new URL("./files/profit@1",import.meta.url)],
      ["statecodes@1.csv",new URL("./files/statecodes@1",import.meta.url)],
      ["sea19.csv",new URL("./files/sea19",import.meta.url)]]);
